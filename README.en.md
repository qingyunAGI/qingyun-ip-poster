...
<p align="center">
  <strong>Not one poster. A repeatable visual system for continuous publishing.</strong>
</p>

<p align="center"><code>$qingyun-ip-poster</code></p>

<p align="center">
  <a href="README.md">Visual Home</a> ·
...
<table>
  <tr>
    <td width="33.33%"><img src="assets/style-references/04-high-contrast-closeup.png" alt="Business IP close-up poster"></td>
    <td width="33.33%"><img src="assets/style-references/08-cyber-xianxia-worldview-keyart-dark.png" alt="Creative character worldview key art"></td>
    <td width="33.33%"><img src="assets/style-references/10-event-lineup-monumental.png" alt="9:16 event campaign master"></td>
  </tr>
</table>
...
<table>
  <tr>
    <th width="38%">Before</th>
    <th width="24%">Visual DNA</th>
    <th width="38%">After using the Skill</th>
  </tr>
  <tr>
    ...
    <td align="center" valign="middle">
      Subject anchor<br><br>
      Headline hierarchy<br><br>
      Grid and footer<br><br>
      Thumbnail recognition<br><br>
      <strong>Poster → System</strong>
    </td>
...
<table>
  <tr>
    <td width="50%" rowspan="2"><img src="assets/style-references/04-high-contrast-closeup.png" alt="Wang Lei high-contrast close-up poster"></td>
    <td width="25%"><img src="assets/style-references/01-black-neon-green.png" alt="Wang Lei black and neon-green summit poster"></td>
    <td width="25%"><img src="assets/style-references/02-ivory-editorial.png" alt="Wang Lei ivory editorial poster"></td>
  </tr>
  <tr>
    <td><img src="assets/style-references/03-graphite-thought-leader.png" alt="Wang Lei graphite thought-leader poster"></td>
    <td><img src="assets/style-references/05-black-gold-authority.png" alt="Wang Lei black-and-gold authority poster"></td>
  </tr>
</table>
...
| --- | --- | --- | --- |
| Business IP batch | Account audit + 7 distinct directions; refine 1–3 | Existing grid (optional) + 3–5 portraits + statement/credentials | 3:4 |
...
This is not a larger image folder attached to the old workflow. Version 1.2 can audit an existing account first, define its visual DNA, and then select the required materials, ratio, grid, batch size, and quality gates. Event campaigns follow the actual speaker count instead of forcing every request into 5/7/10 outputs.
...
1. **Audit** the existing account grid when supplied: subject anchor, hierarchy, series order, and thumbnail readability.
2. **Route** the request into business IP, keynote, event campaign, or character key art.
3. **Compile facts** into one information card with supplied, verified, and unverified states.
4. **Define visual DNA** across typography, grid, subject scale, color, identity zone, and footer.
5. **Generate and typeset** with separate artwork and exact-content layers.
6. **Run QA twice**: once for each poster, then again for the grid and platform crop.
...
│   └── version-matrix.md
├── README.md                    # Chinese-first visual homepage
...
Current version: **1.2.0 Visual System Edition**. No open license is currently included; contact the author before redistribution or commercial repackaging.
